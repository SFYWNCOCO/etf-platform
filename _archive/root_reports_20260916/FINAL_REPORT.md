...
| 测试项 | 状态 | 说明 |
|--------|------|------|
| ETF数量检查 | [OK] 通过 | 592只ETF，无重复，无缺失 |
| 数据源健康检查 | [FAIL] 失败 | 2个价格源失效 (东财/AKShare) |
| 新闻数据检查 | [OK] 通过 | 4个新闻源正常 |
| 推荐功能检查 | [OK] 通过 | 分析和筛选功能正常 |
| AKShare问题检查 | [OK] 通过 | 字段映射问题已确认 |

**总体评估**: [警告] **4/5测试通过，需要修复数据源问题**
...
### 1.2 数据质量
- [OK] **无重复code**: 592个唯一code
- [OK] **无缺失字段**: 所有ETF都有name、sector、risk_level
- [OK] **元数据一致**: _meta.count = 592
...
|--------|------|------|----------|
| **新浪** | [OK] 健康 | 117ms | 无 |
| **东方财富** | [警告] 降级 | 0ms | No valid price |
| **AKShare** | [警告] 降级 | 1256ms | No valid price |
...
| 数据源 | 状态 | 延迟 | 备注 |
|--------|------|------|------|
| **华尔街见闻** | [OK] 健康 | 274ms | 专业财经新闻 |
| **36氪** | [警告] 降级 | 3196ms | 响应较慢 |
| **新浪财经** | [OK] 健康 | 234ms | 行业分类新闻 |
| **腾讯新闻** | [OK] 健康 | 340ms | 综合新闻 |
